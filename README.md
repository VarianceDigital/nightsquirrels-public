# Minimal Flask + Boostrap 5 + Question/Answer project 
...
The project implements *NightSquirrels*, a demo application featuring a gallery of cat images and showcasing a complete and up-and-running flow for **USER AUTHENTICATION** and **USER AUTHORIZATION** .
...
Now gitted on GitHub here: [nightsquirrel](https://github.com/VarianceDigital/nightsquirrel)
